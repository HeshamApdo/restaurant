                    ...
                    <div className="flex flex-col xl:flex-row justify-center items-center">
                        {soda.compo.map((el) =>(
                            <div className="flex flex-col xl:flex-row gap-5 xl:gap-[40px] justify-center items-center">
                                <div className="flex justify-center items-center w-[300px] sm:w-[300px] xl:w-[300px] h-[400px]">
                                    <div className="flex justify-center items-center w-[100px] sm:w-[100px] xl:w-[100px] h-[100px]">
