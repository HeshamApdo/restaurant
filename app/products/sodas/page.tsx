                    ...
                    <div className="flex flex-row gap-2 w-[300px] sm:w-[400px] h-[300px] border border-black rounded-xl items-center bg-slate-200">
                        {soda.compo.map((el) =>(
                            ...
                            <div className="flex flex-row gap-2 w-[300px] sm:w-[400px] h-[300px] border border-black rounded-xl bg-slate-200 relative p-5">
                                <div className="w-[100px] sm:w-[150px] border-r-2 border-black flex justify-center items-center">
                                <div className="w-[50px] sm:w-[100px] h-[100%] flex justify-center items-center sm:p-3">
                                ...
                                <div className="flex flex-col gap-5">
                                    ...
                                    <Link href={`/products/sodas/${soda.id}`} className="absolute bottom-10" title="more info">
